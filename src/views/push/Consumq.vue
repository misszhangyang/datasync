...
<template>
  <div>
    ...
    <el-breadcrumb separator-class="el-icon-arrow-right">
      ...
      <el-breadcrumb-item>MQ消费</el-breadcrumb-item>
    </el-breadcrumb>
    <!-- 搜索筛选 -->
      ...
      <el-form label-width="100px" :model="editForm" ref="editForm">
        <el-row>
          <el-col :span="22">
            ...
            <el-form-item label="消息来源">
              <el-input size="small" v-model="editForm.sourceType" auto-complete="off" placeholder="请输入推送状态" disabled></el-input>
            </el-form-item>
...
<script>
import { ConsuMQList, ConsuMQEdit,PushMQList, PushMQEdit} from '../../api/payMG'
