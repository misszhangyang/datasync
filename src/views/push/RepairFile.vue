  ...
  <div>
    ...
    <el-form :inline="true" :model="formInline" class="user-search">
      ...
      <el-form-item label="推送状态">
        <el-select class="input" size="small" v-model="formInline.stat" placeholder="推送状态">
    ...
    <el-table size="small" :data="listData" highlight-current-row v-loading="loading" border element-loading-text="拼命加载中" style="width: 100%;">
      ...
      <el-table-column sortable prop="filePath" label="文件路径" width="120" show-overflow-tooltip>
      </el-table-column>
      <el-table-column sortable prop="stat" label="推送状态" width="140" show-overflow-tooltip>
      </el-table-column>
      ...
      <el-form label-width="120px" :model="editForm" ref="editForm">
        <el-row>
          <el-col :span="12">
            ...
            <el-form-item label="推送状态">
              <el-input size="small" v-model="editForm.stat" auto-complete="off" placeholder="请输入推送状态" disabled></el-input>
            </el-form-item>
    ...
    getdata(parameter) {
      ...
      let res = {
        ...
        data: [
          {
            batchId: '2132131',
            targetId: '1526380193000',
            filePath: '/dsad/dada',
            stat: '成功',
            document: 'wqewwqeqweqeq',
            createTime: 1526380193000,
